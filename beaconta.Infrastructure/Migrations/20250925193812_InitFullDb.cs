        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MenuGroups_MenuSections_SectionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuItemPermissions", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "CreatedAt", "CreatedBy", "Key", "Name", "UpdatedAt", "UpdatedBy" },
                values: new object[] { 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "", "admin", "Admin", null, null });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreatedAt", "CreatedBy", "Email", "FullName", "LastLogin", "Notes", "PasswordHash", "Phone", "Status", "UpdatedAt", "UpdatedBy", "Username" },
                values: new object[] { 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "", "", "System Admin", null, "", "$2a$11$PZFFdWWmQ8ysU7gDys7y4Oe47FTaGcIztUbDR1V27R.gU70KCVT1S", "", "Active", null, null, "admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuGroups_SectionId",
                table: "MenuGroups",
                column: "SectionId");

            migrationBuilder.CreateIndex(
                name: "IX_MenuItemPermissions_MenuItemId",
